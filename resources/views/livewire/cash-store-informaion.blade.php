        ...
        <div class="card p-2">
            <div class="row">
                <div class="col-md-6 col-12" >
                    ...
                    <p>العنصر المطلوب: <span class="text-success">{{ $cash->item }} </span></p>
                    <p>الكمية: {{ $cash->num }}
                        <span class="text-danger">
                            {{ $cash->unite }}</span>
                    </p>
                    <p>المقابل: {{ $cash->note }}</p>
                    <p>حالة الطلب:
                        @if ($cash->stute == 0)
                    ...
                    <form wire:submit='SaveEdite' method="post" wire:ignore.self>
                        <label class="form-lable" for="">العنصر</label>
                        <input wire:model='item' type="text" class="form-control" name="" id="">

                        <label class="form-lable" for="">الكمية</label>
                        <input wire:model='num' type="number" class="form-control" name="" id="">
                        <label class="form-lable" for="">الوحدة</label>
                        <input wire:model='unite' type="text" class="form-control" name="" id="">

                        <label class="form-lable" for="">ملاحظات</label>
