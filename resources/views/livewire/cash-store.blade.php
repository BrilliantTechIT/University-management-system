<div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table wire:poll.15s class="table align-items-center mb-0" id="S_table">
                                <thead>
                                    <tr>
    ...
    <div wire:ignore.safe class="modal fade" id="save1" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit="StoreCashStoreTable" id ="addccollage" method="post">


                        <div class="form-group">
                            <label for="name1" class="col-form-label">العنصر</label>
                            <input class="form-control" name="item" wire:model="item" id="name1" required>
                        </div>
                        <div class="form-group">
                            <label for="name1" class="col-form-label">الكمية</label>
                            <input class="form-control" type="number" wire:model="num" name="num" id="name1"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="name1" class="col-form-label">الوحدة</label>
                            <input class="form-control" wire:model="unite" name="unite" id="name1" required>
                        </div>

                        <div class="form-group">
                            <label for="name1" class="col-form-label">ملاحظة</label>
                            <input class="form-control" wire:model="note" name="note" id="name1" required>
                        </div>
    ...
    <script>
        ...
        Livewire.on('SendResult', event => {
        // console.log(event);
            
            SocketIO.emit('send_cashstore',event[0],event[1]);
        });
    });
...
{{-- <body>
    ...
    @section('contain')
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <script>
                     function js_CashStore(item, num,unite,note,date,createBy,id,juserid,juserimage,sendname,sendid) {
                ...
                @if (session('done'))
                <script>
                      js_CashStore('{{$item}}','{{$num}}','{{$unite}}','{{$note}}','{{$date}}','{{$createBy}}','{{$id}}',{{$juserid}},'{{$juserimage}}','{{$sendname}}','{{$sendid}}');
                </script>
                                        ...
                                        @foreach ($cash as $item)
                                            <tr id="Aid{{ $item->id }}">
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <form action="{{ route('DeleteCashStoreTable') }} " method="POST">
            ...
            <div class="modal fade" id="save1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id ="addccollage" action="{{ route('StoreCashStoreTable') }}" method="post">
                                @csrf
