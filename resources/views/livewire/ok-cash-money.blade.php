                                ...
                                <div class="col-md-6 col-12">
                                    <div class="card-container">
                                        ...
                                        <main class="main-content">
                                            ...
                                            <h2>
                                                مبلغ:{{ $item->money }} {{ $item->omlh }}
                                            </h2>

                                            <p>المقابل:{{ $item->opposite }}</p>
                                            <center>
                                            ...
                                            <center>
                                                <div class="row">
                                                    <div class="col-md-3 col-12" style="margin: 10px">
                                                        <form wire:submit='StoreOkCashMoney({{ $item->id }})'
                                                            method="POST">
                                                    ...
                                                    <div class="col-md-3 col-12" style="margin: 10px">
                                                        <form wire:submit='NoOkCashMoney({{ $item->id }})'
                                                            method="POST">
                                                    ...
                                                    <div class="col-md-3 col-12" style="margin: 10px">
                                                        <a class="btn btn-info"
                                                            href="{{ route('CashMoneyInformaion', ['id' => $item->uid]) }}">عرض</a>
                                                    </div>
            ...
            <script>
                ...
                <div class="col-md-6 col-12">
                                        <div class="card-container">
                                                ...
                                                <img class="hero-image" src="users_image/${data.sendim}"
                                                    alt="Spinning glass cube" />
                                            ...
                                            <main class="main-content">
                                                ...
                                                <h2>
                                                    مبلغ:${data.money} ${data.omlh}
                                                </h2>

                                                <p>المقابل:${data.opposite}</p>
                                                <center>
