            ...
            <div class="col-12" >
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="row" id="targetRow" wire:poll>
                                            ...
                                            <center>
                                                <div class="row">
                                                    <div class="col-md-3 col-12" style="margin: 10px">
                                                        <button wire:click='StoreOkCashstore({{$item->id}})' type="button" name="delete"
                                                            class="mb-0 text-md fa fa-check fa-2x btn btn-success">موافق</button>
                                                    </div>
                                                    <div class="col-md-3 col-12" style="margin: 10px">

                                                        <button wire:click='NoOkCashstore({{$item->id}})' type="button" name="delete"
